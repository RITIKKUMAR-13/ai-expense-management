...
export default function ExpenseWorkspace() {
  ...
  const titleMap: Record<string, { eyebrow: string; title: string; copy: string }> = {
    ...
    "/savings": { eyebrow: "SAVINGS GOALS", title: "Turn important purchases into a plan.", copy: "Create a goal for your laptop, mobile or other purchase, then add savings at your own pace." },
  ...
  return <DashboardLayout><div className="expense-workspace">
    ...
    {page === "/" && <>
      ...
      <SavingsGoalsPanel mode="preview" />
    </>}
    ...
    {page === "/savings" && <SavingsGoalsPanel mode="page" />}
